...
function createtodo(arr, element, text) {
    ...
    arr.forEach(obj => {
        ...
        newBtn.classList.add("delete", "btn","btn-danger", );
        newList.classList.add("site-item", "d-flex", "justify-content-between", "mb-3", "bg-success","text-white", "fw-bold", "rounded-4", "p-3");
